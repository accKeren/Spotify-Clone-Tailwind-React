const HomeIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} class="Svg-sc-1bi12j5-0 EQkJl home-active-icon" viewBox="0 0 24 24">
...
const SearchIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} class="Svg-sc-1bi12j5-0 EQkJl search-icon" viewBox="0 0 24 24">
...
const CollectionIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} class="Svg-sc-1bi12j5-0 EQkJl collection-icon" viewBox="0 0 24 24">
...
const PlusIcon = ({ size }) => {
    return (
        <svg height={size} width={size} aria-hidden="true" viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 EQkJl">
...
const DownloadIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} viewBox="0 0 24 24" class="Svg-sc-1bi12j5-0 EQkJl">
...
const PrevIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} class="Svg-sc-1bi12j5-0 eENWnB IYDlXmBmmUKHveMzIPCF" viewBox="0 0 24 24">
...
const NextIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size}  class="Svg-sc-1bi12j5-0 eENWnB IYDlXmBmmUKHveMzIPCF" viewBox="0 0 24 24">
            <path fill="currentColor"d="M8.043 2.793a1 1 0 000 1.414L15.836 12l-7.793 7.793a1 1 0 101.414 1.414L18.664 12 9.457 2.793a1 1 0 00-1.414 0z"/></svg>
    )
}
const DownDirIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} class="Svg-sc-1bi12j5-0 EQkJl eAXFT6yvz37fvS1lmt6k" viewBox="0 0 16 16">
...
const LinkIcon = ({ size }) => {
    return (
<svg role="img" height={size} width={size} viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 EQkJl">
...
const ComputerIcon = ({ size }) => {
    return (
<svg role="img" height={size} width={size} class="Svg-sc-1bi12j5-0 EQkJl" viewBox="0 0 16 16">
...
const ScreenIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 EQkJl">
            <path fill ="currentColor"  d="M6.53 9.47a.75.75 0 010 1.06l-2.72 2.72h1.018a.75.75 0 010 1.5H1.25v-3.579a.75.75 0 011.5 0v1.018l2.72-2.72a.75.75 0 011.06 0zm2.94-2.94a.75.75 0 010-1.06l2.72-2.72h-1.018a.75.75 0 110-1.5h3.578v3.579a.75.75 0 01-1.5 0V3.81l-2.72 2.72a.75.75 0 01-1.06 0z"></path>
        </svg>
    )
}
const HearthFilled = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 EQkJl">
...
const VolumeMute = ({ size }) => {
    return (
<svg role="presentation" height="16" width="16" aria-label="Ses kapalı" id="volume-icon" viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 EQkJl">
    <path fill="currentColor" d="M13.86 5.47a.75.75 0 00-1.061 0l-1.47 1.47-1.47-1.47A.75.75 0 008.8 6.53L10.269 8l-1.47 1.47a.75.75 0 101.06 1.06l1.47-1.47 1.47 1.47a.75.75 0 001.06-1.06L12.39 8l1.47-1.47a.75.75 0 000-1.06z"></path>
...
const VolumeLow = ({ size }) => {
    return (
<svg role="presentation" height={size} width={size} viewBox="0 0 16 16" class="Svg-sc-1bi12j5-0 EQkJl">
